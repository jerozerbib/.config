...
ICON=/home/jeremy/.i3/death-star.png

scrot $IMAGE
convert $IMAGE -scale 10% -scale 1000% -fill black -colorize 25% $IMAGE
[ -f $TEXT ] || {
    convert -size 400x60 xc:black -font Fantasque-Sans-Mono-Regular-Nerd-Font-Complete-Mono -pointsize 26 -fill white -gravity center -annotate +0+0 'Type password to unlock' $TEXT;
